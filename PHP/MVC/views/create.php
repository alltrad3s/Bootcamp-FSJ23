...
<body>
    ...
    <div class="content">
        <h1 class="title has-text-centered">Create New Product</h1>
        ...
        <form class="form-container" action="./index.php?action=create" method="POST">
            <div class="field">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" name="descuento">
                </div>
            </div>
